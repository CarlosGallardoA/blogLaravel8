...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.home','description' => 'Ver el dashboard'])->syncRoles([$role1,$role2]); //->assignRole($role1) Solo para un role  ->syncRoles([$role1,$role2]) para mas riles
